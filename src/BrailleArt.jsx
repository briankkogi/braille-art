...
export default function BrailleArt() {
  ...
  return (
    ...
    >
      ...
      <a
        href="https://github.com/briankkogi/braille-art"
        target="_blank"
        rel="noopener noreferrer"
        className="braille-github-link"
      ...
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        ...
        <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", color: "#fff", marginTop: 16, textTransform: "uppercase" }}>
